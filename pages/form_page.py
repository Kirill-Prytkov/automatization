...
class FormPage(BasePage):
    ...
    def fill_form_fields(self):
        ...
        self.element_is_visible(self.locators.LATS_NAMAE).send_keys(person.last_name)
        self.element_is_visible(self.locators.EMAIL).send_keys(person.email)
        self.element_is_visible(self.locators.GENDER).click()
        self.element_is_visible(self.locators.MOBILE).send_keys(person.mobile_phone)
        ...
        self.element_is_visible(self.locators.STATE_CITY).click()
